              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    key={index}
                    href="#"
                    className={`p-3 rounded-xl bg-white/80 backdrop-blur-sm border border-white/50 shadow-md transition-all duration-300 ${social.color}`}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-[#501F08] to-transparent opacity-0 transition-opacity duration-300 focus-within:opacity-100"></div>
                </div>
