          ...
          <div className="lg:col-span-4">
            <div className="bg-white rounded-[32px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 lg:sticky lg:top-32">
              ...
              <button
                ...
                className="w-full bg-[#501F08] text-white py-4 rounded-xl font-black text-[12px] tracking-[0.2em] uppercase hover:bg-[#3a1606] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:shadow-[#501F08]/20 flex items-center justify-center gap-3"
              >
                    ...
                    {addressLoading
                      ...
                      : addresses.map((addr) => (
                          <div
                            ...
                            className={`relative cursor-pointer p-5 rounded-[20px] border-2 transition-all duration-200 group flex items-start gap-4 ${
