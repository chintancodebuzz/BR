...
import { OrderSkeleton } from "../../../components/common/loading-skeletons";
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-6 mb-4">
          <div className="w-14 h-14 bg-gray-50 animate-pulse rounded-[22px]"></div>
          <div className="space-y-3">
            <div className="h-8 w-48 bg-gray-50 animate-pulse rounded-lg"></div>
            <div className="h-4 w-64 bg-gray-50 animate-pulse rounded-md"></div>
          </div>
        </div>
        <OrderSkeleton count={1} />
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 h-64 bg-gray-50 animate-pulse rounded-3xl" />
          <div className="h-64 bg-gray-50 animate-pulse rounded-3xl" />
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="space-y-1.5">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <span
                className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border transition-colors ${getStatusColor(
                  order.status
                )}`}
              >
                {order.status}
