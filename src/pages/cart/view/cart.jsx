                ...
                {loading ? (
                    ...
                    <div className="text-center py-32 bg-white rounded-[40px] border border-gray-100 shadow-xl max-w-2xl mx-auto mt-12 flex flex-col items-center relative overflow-hidden">
                        ...
                        <button
                            ...
                            className="relative z-10 px-12 py-4 relative group overflow-hidden bg-transparent border-2 border-[#501F08] text-[#501F08] rounded-2xl font-black text-xs tracking-[0.2em] transition-all duration-300 hover:text-white hover:shadow-2xl flex items-center gap-3 uppercase"
                        >
                            <div className="absolute inset-0 bg-[#501F08] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                        ...
                        <div className="lg:col-span-4 xl:col-span-3">
                            <div className="bg-white rounded-[32px] border border-gray-100 shadow-[0_20px_50px_rgba(80,31,8,0.05)] p-8 lg:sticky lg:top-32 overflow-hidden relative">
                                ...
                                <div className="space-y-2 relative z-10">
                                    <button className="w-full relative group overflow-hidden bg-transparent border-2 border-[#501F08] text-[#501F08] py-3 rounded-2xl font-black text-sm tracking-[0.1em] transition-all duration-300 hover:text-white hover:shadow-xl uppercase" onClick={() => navigate("/checkout")}>
                                        <div className="absolute inset-0 bg-[#501F08] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
