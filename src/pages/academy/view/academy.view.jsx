        ...
        <div className="space-y-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="h-20 md:h-24 bg-white border border-gray-100 rounded-2xl md:rounded-3xl p-3 md:p-6 flex items-center gap-2 md:gap-4"
              >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white border border-gray-100 rounded-[32px] p-8 space-y-6 h-[500px]"
              >
                <Skeleton className="h-6 w-24 rounded-full" />
                <Skeleton className="h-8 w-3/4" />
                <div className="space-y-4">
                  {[1, 2, 3, 4].map((j) => (
                    <Skeleton key={j} className="h-4 w-1/2 opacity-40" />
                  ))}
                </div>
                <div className="pt-4">
            ...
            {courses.map((course, index) => (
              <div
                ...
                className={`relative group cursor-pointer transition-all duration-500 ${
                  selectedCourse === index ? "md:scale-105 z-10" : ""
                }`}
