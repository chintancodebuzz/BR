...
const Academy = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      color: "from-[#501F08]/10 via-[#9e5d61]/10 to-[#501F08]/10",
      badge: "Certified",
  ...
  return (
    <></>
    // <section className="relative min-h-screen bg-linear-to-b from-[#F8F2E9] via-white to-[#EDE3D9] overflow-hidden">
    ...
    //         <div className="w-64 h-1.5 bg-linear-to-r from-transparent via-[#9e5d61] to-transparent rounded-full mb-4"></div>
    ...
    //               selectedCourse === index ? "scale-105 z-10" : ""
    //             }`}
