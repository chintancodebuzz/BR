...
export default function ProductFilters({ onClose }) {
    ...
    const categories = ['Nail Polish', 'Nail Care', 'Accessories', 'Tools', 'Kits'];
    const sortOptions = [
            ...
            <div className="mb-6">
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <ChevronDown className={`w-5 h-5 text-[#501F08] transition-transform ${isDropdownOpen ? 'rotate-180' : ''}`} />
                    </button>
                            ...
                            <div className="absolute z-20 w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                                {sortOptions.map((option) => (
                                    <button
                                        ...
                                        className={`w-full px-4 py-3 text-left transition-all ${sortBy === option.value
                        ...
                        {collections.map((collection) => (
                            ...
                            >
                                <input
                                    type="radio"
                                    name="collection"
                                    checked={selectedCollection === (collection.name || collection.title)}
                                    onChange={() => dispatch(setSelectedCollection(collection.name || collection.title))}
                    ...
                    {categories.map((category) => (
                        ...
                        >
                            <input
                                ...
                                onChange={() => dispatch(setSelectedCategory(selectedCategory === category ? null : category))}
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => dispatch(setPriceRange({ ...priceRange, min: parseInt(e.target.value) }))}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => dispatch(setPriceRange({ ...priceRange, max: parseInt(e.target.value) }))}
                            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#501F08]"
                        />
                    </div>
